...
class BTHomeMiThermometer : public Component, public esp32_ble_tracker::ESPBTDeviceListener {
 public:
 ...
 protected:
  ...
  bool decrypt_bthome_payload(std::vector<uint8_t> &raw, const uint8_t *bindkey, const uint64_t &address);
};
